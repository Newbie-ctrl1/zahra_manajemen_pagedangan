...
export default function TransaksiPemancingPage() {
  const { transactions } = usePemancingan();
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Header */}
      <header className="bg-purple-500 dark:bg-purple-700 text-white shadow-lg">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold">Riwayat Transaksi Pemancingan</h1>
            </div>
      ...
      {selectedTransaction && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
              ...
              {selectedTransaction.items.map((item, index) => (
                <div key={index} className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div className="flex-1">
                    <p className="font-medium text-gray-900 dark:text-white">{item.packageName}</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <button
              onClick={() => setSelectedTransaction(null)}
              className="mt-6 w-full bg-purple-500 hover:bg-purple-600 text-white py-2 rounded-lg font-medium"
            >
              Tutup
            </button>
          </div>
