        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold">Manajemen Pemancingan</h1>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
            Dashboard Pemancingan
          </h2>
          <p className="text-gray-600 dark:text-gray-400">
            Pilih menu untuk mengelola pemancingan Anda
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {/* Menu Kasir */}
          <Link href="/pemancingan/kasir">
          ...
          <Link href="/pemancingan/transaksi">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-2xl transition-all duration-300 hover:scale-105 cursor-pointer border-2 border-transparent hover:border-purple-400">
              <div className="flex flex-col items-center text-center">
